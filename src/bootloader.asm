...
.user:
        dq SD_RING3 | SD_PRESENT | SD_NONTSS | SD_CODESEG | SD_READABLE | SD_GRAN4K | SD_CONFORMING | SD_MODE64
.userdata:
        dq SD_RING3 | SD_PRESENT | SD_NONTSS | SD_DATASEG | SD_WRITABLE | SD_GRAN4K | (SD_MODE64 << 1)
.tss:
        dw 104
        dw tss.tss
        dw 0x89 << 8
